...
INSERT ALL
INTO NeMagCudoviste (IdCudovista, Visina, Duzina, Kandze, BrojGlava, ZiviUVodi, Leti, Otrovno, Tezina) VALUES (2, 200, 220, 'Oštre', 1, 'Ne', 'Ne', 'Ne', 80)
INTO NeMagCudoviste (IdCudovista, Visina, Duzina, Kandze, BrojGlava, ZiviUVodi, Leti, Otrovno, Tezina) VALUES (3, 180, 200, 'Oštre', 1, 'Ne', 'Ne', 'Da', 70)
SELECT * FROM dual;
...
INSERT ALL
INTO Legenda (IdLegende, PrvoPominjanje, TekstLegende, ZemljaPorekla, ImePoznatogPred) VALUES (1, '1000 BC', 'Legenda o Zmaju', 'Kina', 'Smaug')
INTO Legenda (IdLegende, PrvoPominjanje, TekstLegende, ZemljaPorekla, ImePoznatogPred) VALUES (2, '800 BC', 'Legenda o Vukodlaku', 'Evropa', 'Remus')
INTO Legenda (IdLegende, PrvoPominjanje, TekstLegende, ZemljaPorekla, ImePoznatogPred) VALUES (3, '500 BC', 'Legenda o Vampiru', 'Rumunija', 'Drakula')
INTO Legenda (IdLegende, PrvoPominjanje, TekstLegende, ZemljaPorekla, ImePoznatogPred) VALUES (4, '1500 AD', 'Legenda o Vili Ravljoli', 'Francuska', 'Ravljola')
INTO Legenda (IdLegende, PrvoPominjanje, TekstLegende, ZemljaPorekla, ImePoznatogPred) VALUES (5, '700 BC', 'Legenda o Meduzi', 'Grčka', 'Persej')
SELECT * FROM dual;
...
INTO CudImaMagSpos (IdCud, IdMagicnaSpos, IdCudMagSpos) VALUES (5, 5, 5)
SELECT * FROM dual;

INSERT ALL
INTO CudImaSpecSpos (IdCud, IdSpecijalnaSpos, IdCudSpecSpos) VALUES (1, 1, 1)
INTO CudImaSpecSpos (IdCud, IdSpecijalnaSpos, IdCudSpecSpos) VALUES (2, 2, 2)
INTO CudImaSpecSpos (IdCud, IdSpecijalnaSpos, IdCudSpecSpos) VALUES (3, 3, 3)
INTO CudImaSpecSpos (IdCud, IdSpecijalnaSpos, IdCudSpecSpos) VALUES (4, 4, 4)
...
INSERT ALL
INTO Susret (IdSusret, IdLov, ImePP, IdLok, Vreme, Ishod) VALUES (1, 1, 'Smaug', 1, '2023-06-01', 'Pobeda čudovišta')
INTO Susret (IdSusret, IdLov, ImePP, IdLok, Vreme, Ishod) VALUES (2, 2, 'Remus', 2, '2022-10-15', 'Poraz lovca')
INTO Susret (IdSusret, IdLov, ImePP, IdLok, Vreme, Ishod) VALUES (3, 3, 'Drakula', 3, '2023-01-20', 'Pobeda čudovišta')
INTO Susret (IdSusret, IdLov, ImePP, IdLok, Vreme, Ishod) VALUES (4, 4, 'Ravljola', 4, '2023-03-05', 'Neodlučan ishod')
INTO Susret (IdSusret, IdLov, ImePP, IdLok, Vreme, Ishod) VALUES (5, 5, 'Persej', 5, '2022-12-10', 'Pobeda lovca')
SELECT * FROM dual;